    ...
    <div id="contenedor">	
     ...
     <div>⠀⠀</div>                       
       ...
       <fieldset style="margin:auto" class="z-depth-4" >
           ...
           <form method="post" class="login-form" id="form" name="f_EditarDatosPersona" action="datosusuarios.jsp">
                <div>
...
<fieldset style="margin:auto" class="z-depth-4" >
                ...
                <form method="post" action="datosusuarios.jsp" class="login-form" id="form" name="f_datospersonaformulario">
                    
                    <div>
                    <div class="input-field col s12 center">
                        <p class="center login-form-text">Registrar Nuevo Usuario</p>
                    </div>
                </div>
                ...
                %>
                                        <div class="rown">
                                            ...
                                            <div class="cell" data-title="Eliminar">
                                                <a href="datosusuarios.jsp?f_accion=E&f_idusuario=<%out.print(idp);%>"><i class="icon-trash icon-large"></i></a>
                                            ⠀⠀
                                                <a href="datosusuarios.jsp?f_accion=M1&f_idusuario=<%out.print(idp);%>" style="color:#0091ea"><i class="icon-pencil icon-large " ></i></a>
                                            </div>
                                        </div>
                                        <%
                                                }
                                        ...
                                        <div class="rown">
                                            <div class="cell">
                                                <a href="datosusuarios.jsp?f_accion=C1" class="center"><i class="icon-plus icon-large"></i></a>
                                            </div>
                                            <div class="cell">
                                            </div>
                                            <div class="cell">
